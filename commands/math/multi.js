...
module.exports = {
    name: 'multi',
    description:("Calculate the multiplication of 2 numbers!"),
    options: [
        {
            name: 'num1',
    ...
    async execute({ inter, client }) {
        ...
        .setTitle(await Translate('Calculate the multiplication of 2 numbers!'))
        .setDescription(await Translate(`The result: **${num1}** x **${num2}** = **${result}**`))
        .setTimestamp()
